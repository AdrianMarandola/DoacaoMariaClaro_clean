...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:3000", "https://doacao-maria-claro.vercel.app", "https://main.d2y2snun4xtyx8.amplifyapp.com","https://main.dt5hdcpv4b49e.amplifyapp.com") // Permite apenas o seu frontend
              .AllowAnyHeader()
              .AllowAnyMethod();
    });
});
